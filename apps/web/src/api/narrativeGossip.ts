...
const FALLBACK_LINES: Record<string, Partial<Record<string, string>>> = {
  mira: {
    ...
    FASCIST_AGITATION: "There were flyers on the corners this morning. Trying to split the block along old lines.",
  ...
  leo: {
    ...
    FASCIST_AGITATION: "There's a march being planned. Town Hall hasn't said a word about it yet.",
  ...
  elena: {
    ...
    FASCIST_AGITATION: "They were handing out flyers near the Solar Quarter. We took them all down.",
