...
- [x] **Milestone M24**: [Economy & Energy Rebalance](../tasks/M24-economy-and-energy-rebalance.md) — planned and implemented same-day 2026-09-16, first of a 5-part follow-up request (multiplayer trading, more NPCs/minigames, economy dynamics, real news feed); gave players a real repeatable earn action and fixed a documented energy-multiplier no-op. Multiplayer trading, NPC/minigame expansion, and real-news-feed integration are the remaining milestones from that request.
